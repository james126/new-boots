...
const CustomInput = forwardRef<CustomInputRef, CustomInputProps>((props, ref) => {
  ...
  return (
    props.label === "Project name" ? <View style={{marginTop: 16, backgroundColor: theme.colors.primaryContainer}}>  : 
    <View style={{marginTop: 16, backgroundColor: theme.colors.primaryContainer}}></View>
