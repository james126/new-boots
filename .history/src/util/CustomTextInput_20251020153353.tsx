...
const CustomInput = forwardRef<CustomInputRef, CustomInputProps>((props, ref) => {
  ...
  const getViewStyle = () => {
    if (props.label === "Project name") {
      return {marginTop: 16, backgroundColor: theme.colors.primaryContainer}
    } else {
      return {marginTop: 10, backgroundColor: theme.colors.primaryContainer
    }
  }
