  ...
  return (
    <View style={{ marginTop: 16, backgroundColor: theme.colors.primaryContainer}}>
      <TextInput
        ...
        value={props.inputType === InputTypes.DATE ? props.value : input || ''} // Provide fallback for null
        ...
        right={props.right}  
        error={false} //override props.error to avoid error label styling
      />
         <HelperText type="error" visible={hasError && props.error}>
