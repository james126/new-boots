...
import { View, Dimensions, ViewStyle, TextStyle, ImageStyle } from 'react-native';
import { Button, Card, Text } from 'react-native-paper';
import { headingLarge, headingStyle } from "../styles/heading/headingLarge"
...
const Heading = (props: HeadingProps) => {
    ...
    const [style, setStyle] = useState<Record<string, ViewStyle | TextStyle | ImageStyle>>()
    const [style, setStyle] = useState<ReturnType<typeof headingLarge>>()
    useEffect(() => {
