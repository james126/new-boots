            ...
            <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center'}}>
                ...
                <View>
                    ...
                    <View style={headingStyle.buttonView}>
                        <Button style={{paddingTop: 10}} labelStyle={headingStyle.buttonText} buttonColor={clayPalette.brownOrange} mode="contained" onPress={props.handleNextPage}>Let's go!</Button>
                    </View>
                </View>
