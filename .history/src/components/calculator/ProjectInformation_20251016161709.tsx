                    ...
                    <Card style={formCardStyle.card}>
                        <Card.Content style={{ marginTop: 0, paddingTop: 0 }}>
                            <CustomInput
                                ...
                                error={displayError && error.projectName}
                                displayError={displayError && error.projectName}
                            />
                            <CustomInput
                                ...
                                error={displayError && error.siteArea}
                                displayError={displayError && error.siteArea}
                            />
                            <CustomInput
                                ...
                                inputType={InputTypes.TEXT}
                                error={displayError && error.duration}
                                displayError={displayError && error.duration}
                            />
                            <CustomInput
                                ...
                                editable={true}
                                error={displayError && error.startDate}
                                displayError={displayError && error.startDate}
                            />
                            <DatePickerModal
                                locale="en"
                                mode="single"
