...
import { getBreakpoint, BreakpointHeights, Breakpoints } from '../styles/breakpoints';
...
const Heading = (props: HeadingProps) => {
    ...
    const [breakpoint, setBreakpoint] = useState<number>(BreakpointHeights.MEDIUM);
    ...
    useEffect(() => {
        ...
        console.log(`Screen dimensions changed: height=${height}, width=${width}`);
        ...
        <View style={headingStyle.parentView}>
            <View>
                ...
                <View style={headingStyle.svgView}>
                    <Svg style={{ flex: 1 }}>
                        {getSvgText(breakpoint >= BreakpointHeights.LARGE ? Breakpoints.LARGE : breakpoint >= BreakpointHeights.MEDIUM ? Breakpoints.MEDIUM : Breakpoints.LARGE, 'Subdivision Calculator') }
                    </Svg>
                </View>
            </View>
                ...
                <View>
                    <Card style={headingStyle.card}>
                        ...
                        <View style={headingStyle.textView}>
                            <Card.Content>
                                <Text variant={breakpoint >= BreakpointHeights.LARGE ? "headlineLarge" : breakpoint >= BreakpointHeights.SMALL ? "headlineMedium" : "headlineSmall" } style={headingStyle.bodyText}>Subdivision feasibility calculator for buyers, developers and investors</Text>
                            </Card.Content>
                        </View>
                    </Card>
