            ...
            <View>
                ...
                <View style={headingStyle.svgView}>
                    <Svg style={{ flex: 1 }}>
                        ...
                        <SvgText fontFamily='Montserrat-ExtraBold' fontSize={38} fill="none" stroke='white' strokeWidth='2' x="50%" y="35" textAnchor="middle">Feasibility</SvgText>
                        {/* Fill layer for "Feasibility" */}
                        <SvgText fontFamily='Montserrat-ExtraBold' fontSize={38} fill={theme.colors.secondary} x="50%" y="35" textAnchor="middle">Feasibility</SvgText>
                        {/* Stroke layer for "Calculator" */}
                        <SvgText fontFamily='Montserrat-ExtraBold' fontSize={38} fill="none" stroke='white' strokeWidth='2' x="50%" y="75" textAnchor="middle">Calculator</SvgText>
                        {/* Fill layer for "Calculator" */}
                        <SvgText fontFamily='Montserrat-ExtraBold' fontSize={38} fill={theme.colors.secondary} x="50%" y="75" textAnchor="middle">Calculator</SvgText>
                    </Svg>
                </View>
            </View>
                ...
                <View>
                    <Card style={headingStyle.card}>
                        ...
                        <View style={headingStyle.textView}>
                            <Card.Content>
                                <Text variant={breakpoint >= Breakpoints.LARGE ? "headlineLarge" : "headlineMedium" } style={headingStyle.bodyText}>Subdivision feasibility calculator for buyers, developers and investors</Text>
                            </Card.Content>
                        </View>
                    </Card>
