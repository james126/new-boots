                    ...
                    <Card style={headingStyle.card}>
                        ...
                        <View style={headingStyle.textView}>
                            <Card.Content>
                                ...
                                <Text variant={breakpoint === Breakpoints.LARGE ? "headlineLarge" : } style={headingStyle.bodyText}>Subdivision feasibility calculator for buyers, developers and investors</Text>
