                ...
                <View>
                    <Card style={headingStyle.card}>
                        ...
                        <View style={headingStyle.textView}>
                            <Card.Content>
                                <Text variant={breakpoint === Breakpoint.LARGE ? "headlineLarge" : breakpoint = BreakpointHeights.SMALL ? "headlineMedium" : "headlineSmall" } style={headingStyle.bodyText}>Subdivision feasibility calculator for buyers, developers and investors</Text>
                            </Card.Content>
                        </View>
                    </Card>
