...
import { progressIndicatorLarge } from '../styles/progress-indicator/progressIndicatorLarge';
...
export default function ProgressIndicator({ currentPage, onStepPress, labels, breakpoint }: ProgressIndicatorProps) {
  ...
  const [indicatorStyles, setIndicatorStyles] = React.useState(progressIndicatorLarge);
