        ...
        <View style={headingStyle.parentView}>
            <View>
                ...
                <View style={headingStyle.svgView}>
                    <Svg style={{ flex: 1 }}>
                        {getSvgText(breakpoint >= BreakpointHeights.LARGE ? Breakpoints.LARGE : breakpoint >= BreakpointHeights.MEDIUM ? Breakpoints.MEDIUM : Breakpoints.SMALL, 'Subdivision Calculator') }
                    </Svg>
                </View>
            </View>
