...
import { View, Dimensions, ViewStyle, TextStyle, ImageStyle, NamedStyles } from 'react-native';
...
const Heading = (props: HeadingProps) => {
    ...
    const [style, setStyle] = useState<{ [key: string]: ViewStyle | TextStyle | ImageStyle }>()
