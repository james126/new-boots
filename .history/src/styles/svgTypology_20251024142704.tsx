...
const getSvgText = (breakpoint: Breakpoint, text: string) => {
   const largeSvg: svgVariables = {
    ...
    return (
        <>
            ...
            <SvgText fontFamily='Montserrat-ExtraBold' fontSize={svgVars.fontSize} fill={'#6200ee'} x="50%" y={svgVars.yPositionWord1} textAnchor="middle">
                {text.split(' ')[0]}
            </SvgText>
