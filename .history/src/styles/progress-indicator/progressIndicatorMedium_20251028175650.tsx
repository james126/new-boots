...
export const mediumIndicatorStyles = {
  ...
  stepStrokeCurrentColor: clayPalette.orange,
  stepStrokeWidth: 2,
  separatorStrokeFinishedWidth: 3,
  stepStrokeFinishedColor: clayPalette.orange,
  stepStrokeUnFinishedColor: '#aaaaaa',
  separatorFinishedColor: clayPalette.orange,
  separatorUnFinishedColor: '#aaaaaa',
  stepIndicatorFinishedColor: clayPalette.orange,
