...
// import DevelopmentSummary from './results/DevelopmentSummary';
// import CostAnalysis from './results/CostAnalysis';
// import RevenueAnalysis from './results/RevenueAnalysis';
// import ProfitabilityMetrics from './results/ProfitabilityMetrics';
// import UnitMixBreakdown from './results/UnitMixBreakdown';
//
// interface Typology {
//   name: string;
//   units: number;
...
// });
//
// const Results: React.FC<Props> = ({ input, formatCurrency, formatPercent }) => {
